...
namespace TAXIDIP1.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public CompaniesController(TDATAXIContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,LegalAddress,LegalData,CreatedAt,UpdaedAt")] Companies companies)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,LegalAddress,LegalData,CreatedAt,UpdaedAt")] Companies companies)
        {
            if (id != companies.Id)
            {
                return NotFound();
