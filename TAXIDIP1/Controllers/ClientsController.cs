...
namespace TAXIDIP1.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AccountId,FirstName,LastName,Phone,Address,CreatedAt,UpdatedAt")] Clients clients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AccountId,FirstName,LastName,Phone,Address,CreatedAt,UpdatedAt")] Clients clients)
        {
            if (id != clients.Id)
            {
                return NotFound();
